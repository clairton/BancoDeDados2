...
/*
  -> ccustomers não existe, porém considerei certa
*/
...
order by cost desc
/*
  -> Considerei certa, porém de preferencia a usar "limit" em vez de "first", pois faz parte do padrã e irá funcionar em todos os bancos
  -> "cost" também é algo especifico do banco que você usou
*/
...
/*
 -> A média do valor dos pedidos deve ser feita com o campo invoices.total, porém considerei certa
*/
...
where total > 10
      ...
      group by products.name
/*
 -> invoices.total se refere ao valor total do pedido em moeda
 -> a quantidade total vendida precisa de SUM em items.quantity
*/
...
/*
  ->Faltou o distinct para selecionar distintamente
*/
